...
{
    "distutils": {
        "name": "update_positions_cy_nogil",
        "sources": [
            "update_positions_cy_nogil.pyx"
        ]
    },
    "module_name": "update_positions_cy_nogil"
}
END: Cython Metadata */
...
#define __PYX_HAVE__update_positions_cy_nogil
#define __PYX_HAVE_API__update_positions_cy_nogil
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'update_positions_cy_nogil' */
...
static PyObject *__pyx_f_25update_positions_cy_nogil_update_positions(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
/* Implementation of 'update_positions_cy_nogil' */
...
static PyObject *__pyx_pw_25update_positions_cy_nogil_1update_positions(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_25update_positions_cy_nogil_update_positions(__Pyx_memviewslice __pyx_v_x0, __Pyx_memviewslice __pyx_v_v0, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_x1, __Pyx_memviewslice __pyx_v_v1, double __pyx_v_dt, __Pyx_memviewslice __pyx_v_m, __Pyx_memviewslice __pyx_v_spring_force, __Pyx_memviewslice __pyx_v_volume_correction_force, double __pyx_v_drag, __Pyx_memviewslice __pyx_v_bc_forces, __Pyx_memviewslice __pyx_v_fixed_nodes, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  /* "update_positions_cy_nogil.pyx":9
 *     cdef int i
 *     cdef int j
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "update_positions_cy_nogil.pyx":10
 *     cdef int j
 *     with nogil:#calculate the acceleration on each node due to the forces acting on the nodes and update the velocites and positions
 *         for i in range(x0.shape[0]):             # <<<<<<<<<<<<<<
 *             for j in range(3):
 ...
 */
        ...
        for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
          ...
          /* "update_positions_cy_nogil.pyx":11
 *     with nogil:#calculate the acceleration on each node due to the forces acting on the nodes and update the velocites and positions
 *         for i in range(x0.shape[0]):
 *             for j in range(3):             # <<<<<<<<<<<<<<
 *                 a[i,j] = (spring_force[i,j] + volume_correction_force[i,j] + bc_forces[i,j] - drag * v0[i,j])/m[i]
 ...
 */
          for (__pyx_t_4 = 0; __pyx_t_4 < 3; __pyx_t_4+=1) {
            ...
            /* "update_positions_cy_nogil.pyx":12
 *         for i in range(x0.shape[0]):
 *             for j in range(3):
 *                 a[i,j] = (spring_force[i,j] + volume_correction_force[i,j] + bc_forces[i,j] - drag * v0[i,j])/m[i]             # <<<<<<<<<<<<<<
 *                 v1[i,j] = a[i,j] * dt + v0[i,j]
 ...
 */
            ...
            *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_12 * __pyx_v_a.strides[0]) )) + __pyx_t_11)) )) = (__pyx_t_13 / __pyx_t_14);
            ...
            /* "update_positions_cy_nogil.pyx":13
 *             for j in range(3):
 *                 a[i,j] = (spring_force[i,j] + volume_correction_force[i,j] + bc_forces[i,j] - drag * v0[i,j])/m[i]
 *                 v1[i,j] = a[i,j] * dt + v0[i,j]             # <<<<<<<<<<<<<<
 *                 x1[i,j] = a[i,j] * dt * dt + v0[i,j] * dt + x0[i,j]
 ...
 */
            ...
            *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_v1.data + __pyx_t_8 * __pyx_v_v1.strides[0]) )) + __pyx_t_7)) )) = (((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_11 * __pyx_v_a.strides[0]) )) + __pyx_t_12)) ))) * __pyx_v_dt) + (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_v0.data + __pyx_t_10 * __pyx_v_v0.strides[0]) )) + __pyx_t_9)) ))));
            ...
            /* "update_positions_cy_nogil.pyx":14
 *                 a[i,j] = (spring_force[i,j] + volume_correction_force[i,j] + bc_forces[i,j] - drag * v0[i,j])/m[i]
 *                 v1[i,j] = a[i,j] * dt + v0[i,j]
 *                 x1[i,j] = a[i,j] * dt * dt + v0[i,j] * dt + x0[i,j]             # <<<<<<<<<<<<<<
 *         for i in range(fixed_nodes.shape[0]):#after the fact, can place nodes back into position if they are supposed to be held fixed
 ...
 */
        ...
        /* "update_positions_cy_nogil.pyx":15
 *                 v1[i,j] = a[i,j] * dt + v0[i,j]
 *                 x1[i,j] = a[i,j] * dt * dt + v0[i,j] * dt + x0[i,j]
 *         for i in range(fixed_nodes.shape[0]):#after the fact, can place nodes back into position if they are supposed to be held fixed             # <<<<<<<<<<<<<<
 *             for j in range(3):
 ...
 */
        ...
        for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
          ...
          /* "update_positions_cy_nogil.pyx":16
 *                 x1[i,j] = a[i,j] * dt * dt + v0[i,j] * dt + x0[i,j]
 *         for i in range(fixed_nodes.shape[0]):#after the fact, can place nodes back into position if they are supposed to be held fixed
 *             for j in range(3):             # <<<<<<<<<<<<<<
 *                 x1[i,j] = x0[i,j]
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("update_positions_cy_nogil.update_positions", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_25update_positions_cy_nogil_1update_positions(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_25update_positions_cy_nogil_update_positions[] = "taking into account boundary conditions, drag, velocity, volume correction and spring forces, calculate the particle accelerations and update the particle positions and velocities";
static PyObject *__pyx_pw_25update_positions_cy_nogil_1update_positions(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("update_positions (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_v0)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("update_positions", 1, 12, 12, 1); __PYX_ERR(0, 5, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_a)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_positions", 1, 12, 12, 2); __PYX_ERR(0, 5, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_x1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_positions", 1, 12, 12, 3); __PYX_ERR(0, 5, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_v1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_positions", 1, 12, 12, 4); __PYX_ERR(0, 5, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_dt)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_positions", 1, 12, 12, 5); __PYX_ERR(0, 5, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_m)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_positions", 1, 12, 12, 6); __PYX_ERR(0, 5, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_spring_force)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_positions", 1, 12, 12, 7); __PYX_ERR(0, 5, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_volume_correction_force)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_positions", 1, 12, 12, 8); __PYX_ERR(0, 5, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_drag)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_positions", 1, 12, 12, 9); __PYX_ERR(0, 5, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_bc_forces)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_positions", 1, 12, 12, 10); __PYX_ERR(0, 5, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 11:
        if (likely((values[11] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_fixed_nodes)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_positions", 1, 12, 12, 11); __PYX_ERR(0, 5, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "update_positions") < 0)) __PYX_ERR(0, 5, __pyx_L3_error)
      }
    ...
    __pyx_v_x0 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x0.memview)) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_v0 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_v0.memview)) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_a = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_a.memview)) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_x1 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x1.memview)) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_v1 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_v1.memview)) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_dt = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_dt == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_m = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[6], PyBUF_WRITABLE); if (unlikely(!__pyx_v_m.memview)) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_spring_force = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[7], PyBUF_WRITABLE); if (unlikely(!__pyx_v_spring_force.memview)) __PYX_ERR(0, 5, __pyx_L3_error)
  ...
  __Pyx_RaiseArgtupleInvalid("update_positions", 1, 12, 12, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 5, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("update_positions_cy_nogil.update_positions", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_25update_positions_cy_nogil_update_positions(__pyx_self, __pyx_v_x0, __pyx_v_v0, __pyx_v_a, __pyx_v_x1, __pyx_v_v1, __pyx_v_dt, __pyx_v_m, __pyx_v_spring_force, __pyx_v_volume_correction_force, __pyx_v_drag, __pyx_v_bc_forces, __pyx_v_fixed_nodes);
...
static PyObject *__pyx_pf_25update_positions_cy_nogil_update_positions(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x0, __Pyx_memviewslice __pyx_v_v0, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_x1, __Pyx_memviewslice __pyx_v_v1, double __pyx_v_dt, __Pyx_memviewslice __pyx_v_m, __Pyx_memviewslice __pyx_v_spring_force, __Pyx_memviewslice __pyx_v_volume_correction_force, double __pyx_v_drag, __Pyx_memviewslice __pyx_v_bc_forces, __Pyx_memviewslice __pyx_v_fixed_nodes) {
  ...
  if (unlikely(!__pyx_v_x0.memview)) { __Pyx_RaiseUnboundLocalError("x0"); __PYX_ERR(0, 5, __pyx_L1_error) }
  if (unlikely(!__pyx_v_v0.memview)) { __Pyx_RaiseUnboundLocalError("v0"); __PYX_ERR(0, 5, __pyx_L1_error) }
  if (unlikely(!__pyx_v_a.memview)) { __Pyx_RaiseUnboundLocalError("a"); __PYX_ERR(0, 5, __pyx_L1_error) }
  if (unlikely(!__pyx_v_x1.memview)) { __Pyx_RaiseUnboundLocalError("x1"); __PYX_ERR(0, 5, __pyx_L1_error) }
  if (unlikely(!__pyx_v_v1.memview)) { __Pyx_RaiseUnboundLocalError("v1"); __PYX_ERR(0, 5, __pyx_L1_error) }
  if (unlikely(!__pyx_v_m.memview)) { __Pyx_RaiseUnboundLocalError("m"); __PYX_ERR(0, 5, __pyx_L1_error) }
  if (unlikely(!__pyx_v_spring_force.memview)) { __Pyx_RaiseUnboundLocalError("spring_force"); __PYX_ERR(0, 5, __pyx_L1_error) }
  if (unlikely(!__pyx_v_volume_correction_force.memview)) { __Pyx_RaiseUnboundLocalError("volume_correction_force"); __PYX_ERR(0, 5, __pyx_L1_error) }
  if (unlikely(!__pyx_v_bc_forces.memview)) { __Pyx_RaiseUnboundLocalError("bc_forces"); __PYX_ERR(0, 5, __pyx_L1_error) }
  if (unlikely(!__pyx_v_fixed_nodes.memview)) { __Pyx_RaiseUnboundLocalError("fixed_nodes"); __PYX_ERR(0, 5, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_25update_positions_cy_nogil_update_positions(__pyx_v_x0, __pyx_v_v0, __pyx_v_a, __pyx_v_x1, __pyx_v_v1, __pyx_v_dt, __pyx_v_m, __pyx_v_spring_force, __pyx_v_volume_correction_force, __pyx_v_drag, __pyx_v_bc_forces, __pyx_v_fixed_nodes, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "update_positions_cy_nogil.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "update_positions_cy_nogil.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "update_positions_cy_nogil.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "update_positions_cy_nogil._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"update_positions", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_25update_positions_cy_nogil_1update_positions, METH_VARARGS|METH_KEYWORDS, __pyx_doc_25update_positions_cy_nogil_update_positions},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_update_positions_cy_nogil(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_update_positions_cy_nogil},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initupdate_positions_cy_nogil(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initupdate_positions_cy_nogil(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_update_positions_cy_nogil(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_update_positions_cy_nogil(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_update_positions_cy_nogil(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'update_positions_cy_nogil' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_update_positions_cy_nogil(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("update_positions_cy_nogil", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_update_positions_cy_nogil) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "update_positions_cy_nogil")) {
      if (unlikely(PyDict_SetItemString(modules, "update_positions_cy_nogil", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "update_positions_cy_nogil.pyx":1
 * cimport cython             # <<<<<<<<<<<<<<
 * 
 * @cython.boundscheck(False)
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init update_positions_cy_nogil", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init update_positions_cy_nogil");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
