...
class SimCriteria:
    def __init__(self,solutions,*args):
        a_norm_avg,a_norm_max,a_particle_norm,particle_separation,iteration,time = self.get_criteria_per_iteration(solutions,*args)
        self.a_norm_avg = a_norm_avg
        self.delta_a_norm = self.a_norm_avg[1:]-self.a_norm_avg[:-1]
        self.a_norm_max = a_norm_max
        self.particle_a_norm = a_particle_norm
        self.particle_separation = particle_separation
    ...
    def get_criteria_per_iteration(self,solutions,*args):
        ...
        return a_norm_avg,a_norm_max,a_particle_norm,particle_separation,np.arange(iterations),time
...
def main2():
    ...
    Hext_series[:,2] = Hext_series_magnitude
